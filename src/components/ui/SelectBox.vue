  ...
  <button
    ...
    :class="
      cn(
        ...
        !isSelected &&
          !disabled &&
          'border-gray-300 bg-white hover:border-(--c-primary)',
        isSelected &&
          !disabled &&
          'border-(--c-primary) bg-(--c-light)',
        disabled &&
      ...
      <svg
        :class="
          cn(
            ...
            isSelected && !disabled && 'text-(--c-primary)',
    ...
    <span
      :class="
        cn(
          ...
          !isSelected &&
            !disabled &&
            'text-gray-950 group-hover/box:text-(--c-primary)',
          isSelected && !disabled && 'text-(--c-primary)',
          disabled && 'text-gray-400'
        )
      "
